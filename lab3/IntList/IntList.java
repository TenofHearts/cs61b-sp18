...
public class IntList
{
	...
	public static IntList catenate(IntList A, IntList B)
	{
		...
		while (p != null)
		{
			if (lst == null)
			{
				lst = new IntList(p.first, null);
				prev = lst;
			}
			else
			{
				prev.rest = new IntList(p.first, null);
				prev = prev.rest;
			}
			p = p.rest;
		}
	...
	{
		IntList Node_to_Add = A;
		IntList Reversed_head = null;
		while (Node_to_Add != null)
		{
			IntList List_to_Add = Node_to_Add.rest;
			Node_to_Add.rest = Reversed_head;
			Reversed_head = Node_to_Add;
			Node_to_Add = List_to_Add;
		}
